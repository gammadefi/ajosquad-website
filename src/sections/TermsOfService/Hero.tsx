...
const Hero = () => {
  return (
    <div className="w-full bg-center bg-cover bg-no-repeat bg-[url('/assets/TermsHeroImage.png')]">
        ...
        <Fade direction="down" triggerOnce>
          <div className='text-lg md:text-2xl text-white flex flex-col gap-3 lg:gap-6'>
            <div className='flex gap-2 items-center'>
              ...
              <p>
                Terms and Condition Guiding Ajosquad
              </p>
            </div>
            <h1 className='lg:w-3/4 md:text-7xl text-4xl font-medium font-ageo'>Ajosquad Terms of Service</h1>
            <p>
