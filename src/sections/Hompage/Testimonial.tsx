    ...
    <section className='py-10 px-5 md:px-10 lg:px-44 lg:py-32 bg-[#08354C] text-white'>
      ...
      <div className='-mr-5 md:-mr-10 lg:-mr-44 custom-scrollbar overflow-hidden hover:overflow-x-scroll'>
        <div className='w-fit py-5 flex gap-5 lg:gap-10 pr-5 md:pr-10 lg:pr-32'>
          <TestimonialCard name='Joseph & Emily, Saskatoon' image={Avatar} testimonial='As an immigrant, saving money for the down-payment on a house seemed like an insurmountable task.
          ...
          <TestimonialCard name='Harrison Nzette, Ontario' image={Avatar} testimonial='This is really a milestone achievement for me made possible through Ajosquad. At first it was really hard, having an income that barely pays the bills month in month out. Another difficult aspect was wanting to do something and being held back due to numerous bills, but we just decided that we needed to make the contribution happen at all cost. We had a focus and we achieved it! we bought our first car in Canada. My Canada story will not be complete without the mention of the Ajosquad team!' />
          <TestimonialCard name='Louis Ozioma, Saskatoon' image={Avatar2} testimonial='Big shout out to the Ajo Squad team! This platform has been an absolute game-changer for me, consistently delivering great financial services. I just realized I received my payment yesterday, and the seamless process is unmatched! Their reliability and efficiency are truly top-notch. A huge thank you for always coming through and making financial management easy. Keep up the amazing work, Ajo Squad! You’re the best!' />
        </div>
      </div>
