  ...
  return (
    <section className='space-y-6 lg:space-y-12 py-10 px-5 md:px-10 lg:px-44 md:py-20 lg:py-32 text-center'>
      ...
      <div className='lg:text-2xl mx-auto flex items-center justify-center flex-col gap-2.5 md:gap-8 md:flex-row lg:w-3/4'>
        <button onClick={() => router.push("https://api.whatsapp.com/send?phone=16394705884&text=Hello")} className="font-medium w-full lg:w-fit rounded-lg p-0.5 bg-gradient-to-r from-[#23454F] via-[#0066FF] to-[#1EB7CF]">
        ...
        <Link  href={"/faq#contact"} className="text-white w-full lg:w-fit font-semibold rounded-lg px-3.5 py-3.5 lg:py-3.5 lg:px-10 bg-primary">
          CONTACT FORM
        </Link >
      </div>
    </section>
