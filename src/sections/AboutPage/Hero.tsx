...
const Hero = () => {
  return (
    <div className="w-full bg-center bg-cover bg-no-repeat lg:h-[100vh] bg-[url('/assets/AboutHeroImage.png')]">
      <div className='w-full pb-10 pt-48 px-3 md:px-8 lg:px-[96px] flex items-center bg-black bg-opacity-40'>
        <div className='text-white flex flex-col gap-2'>
          ...
          <Link className='text-lg my-3 rounded-lg shadow shadow-[#2F2B431A] block w-full  text-center px-4 py-3 bg-white' href="/"><span className='gradient-text'>Try Ajosquad now</span></Link>
        </div>
      </div>
    </div>
  )
